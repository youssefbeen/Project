...
(function() {
  $(document).on("turbolinks:load", function() {
    var charge, check_to_hide_or_show_add_link, check_to_hide_or_show_remove_link, onAddFile;
    onAddFile = function(event) {
      ...
      if (thumbContainer.find('img').length === 0) {
        return thumbContainer.append('<img src="' + url + '" width = "80px" height= "60px" />');
      } else {
    ...
    check_to_hide_or_show_remove_link = function() {
    ...
    $('.body').on('cocoon:after-remove', function() {
    ...
    $('.body').on('cocoon:after-insert', function(e, addedPartial) {
      ...
      check_to_hide_or_show_add_link();
      return check_to_hide_or_show_remove_link();
    });
    $('a.add_fields').data('association-insertion-method', 'append');
    return $('a.add_fields').data("association-insertion-node", 'div.user-photo-form .body');
  });
